...
class OrchestrationState:
    """TypedDict-style state for LangGraph pipeline execution.

    We use a plain dict approach with langgraph since TypedDict
    with Annotated reducers works best as a simple structure.
    """
    pass


# The actual state schema used by LangGraph
